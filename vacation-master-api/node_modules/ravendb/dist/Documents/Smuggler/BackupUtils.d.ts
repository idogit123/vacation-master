export declare class BackupUtils {
    ...
    static isFullBackupOrSnapshot(extension: string): boolean;
    static isFullBackup(extension: string): boolean;
...
export declare function periodicBackupFileExtensionComparator(o1: string, o2: string): 0 | 1 | -1;
