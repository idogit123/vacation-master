...
const KillServerOperationCommand_1 = require("../../Documents/Commands/KillServerOperationCommand");
class ServerWideOperationCompletionAwaiter extends OperationCompletionAwaiter_1.OperationCompletionAwaiter {
    ...
    _getKillOperationCommand(id, nodeTag) {
        return new KillServerOperationCommand_1.KillServerOperationCommand(id, nodeTag);
    }
}
